...
class NoisyDoubleDQNAgent:
    ...
    def update(self, replay_buffer, batch_size, episode_reward=None, episode_num=None):
        ...
        # If we don't have enough data yet, we keep current sigma
        # (or you could do a different logic for early episodes)

        # Apply new sigma to policy and target networks
